...
| `SMTP_HOST`                      | Recomendada | `smtp.gmail.com` — correos del sistema                      |
| `SMTP_PORT`                      | Recomendada | `587`                                                       |
| `SMTP_SECURE`                    | Recomendada | `false` (STARTTLS en 587)                                   |
| `SMTP_USER`                      | Recomendada | Cuenta Gmail del sistema (ej. `soporte.gymapure@gmail.com`) |
...
| `VAPID_SUBJECT`                  | Opcional    | `mailto:soporte.gymapure@gmail.com` (push)                  |
| `ADMIN_NOTIFY_EMAILS`            | Opcional    | Correo(s) admin para alertas futuras                        |
