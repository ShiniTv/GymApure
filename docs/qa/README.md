...
| [UX-DESIGN-AUDIT.md](./UX-DESIGN-AUDIT.md)             | Auditoría diseño (Impeccable/Taste/Emil) P0–P2 |

Automatización relacionada: `npm run test:ux`, `npm run test:ux:browser` — ver [../TESTING.md](../TESTING.md).  
Contexto agentes: `PRODUCT.md`, `DESIGN.md` en la raíz.
