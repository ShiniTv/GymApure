...
export const typography = {
  pageTitle:
    'font-display text-h1 font-semibold text-[var(--color-text)] tracking-[-0.025em] leading-[1.15] sm:text-[1.75rem] lg:text-[1.875rem]',
  ...
  badge: labelCaps,
  cardTitle:
    'font-display text-h2 font-semibold text-[var(--color-text)] tracking-[-0.02em] leading-[1.25]',
  ...
  statValue:
    'font-display text-2xl sm:text-3xl font-semibold text-[var(--color-text)] tracking-[-0.03em]',
