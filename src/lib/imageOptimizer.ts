...
export async function optimizeAvatar(input: Buffer): Promise<{ buffer: Buffer; mime: string }> {
...
export async function optimizeProof(input: Buffer): Promise<{ buffer: Buffer; mime: string }> {
