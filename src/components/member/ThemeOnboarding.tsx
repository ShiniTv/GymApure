  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`flex items-center justify-center gap-2 rounded-xl border p-3 min-h-[var(--touch-min)] transition-all touch-manipulation ${
                theme === 'light'
        ...
        <Button className="w-full min-h-[var(--touch-comfort)]" onClick={handleComplete}>
          Empezar a entrenar
        </Button>
      </div>
    </Modal>
