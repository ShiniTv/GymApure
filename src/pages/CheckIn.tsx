...
import { Fingerprint, CheckCircle, XCircle, LogIn, LogOut } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        >
          <Fingerprint className={cn('h-8 w-8', isCheckIn ? 'text-orange-500' : 'text-blue-500')} />
        </div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400 font-medium">Control de acceso</p>
      </div>
