            ...
            {settingsLoadError && (
              ...
              >
                <p className="text-sm font-semibold text-red-600 dark:text-red-400">
                  No se pudieron cargar los avisos de membresía. Revisa la conexión e intenta de
                  nuevo.
                </p>
              </Card>
            )}
                      ...
                      {opsMetrics.request_metrics.topSlowRoutes.map((route) => (
                        ...
                        >
                          ...
                          <p className="mt-0.5 text-xs text-zinc-700 tabular-nums dark:text-zinc-200">
                            avg {route.avgDurationMs}ms · max {route.maxDurationMs}ms ·{' '}
                            {route.count} req
                          </p>
                        </div>
                      ))}
